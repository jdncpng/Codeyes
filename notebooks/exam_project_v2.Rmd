...
```{sql connection=movie_connection}
/* question 3.2. Finding 10 worst films according to rotten tomatoes audience */
select t1.film_name,
...
```
```{r}
# question 5.1 Finding how genre "Horror, Sci-fi" scored throughout the years
...
```{r}
# question 5.2. Visualizing how genre "Horror, Sci-fi" scored throughout the years based on IMDb 
horrorscifi_by_year %>%
...
```
```{r}
# question 5.3. Visualizing how genre "Horror, Sci-fi" scored  throughout the years based on audience scores
horrorscifi_by_year %>%
...
```
```{r}
# question 5.4. Vizualizing how genre "Horror, Sci-fi" scored throughout the years based on critic scores
horrorscifi_by_year %>%
...
```{sql connection= movie_connection}
/* question 6 Finding the lowest rated genre based on critic scores */
...
```
```{sql connection=movie_connection}
/* question 6.1 Finding the lowest rated genre based on audience score */
...
```{sql connection=movie_connection}
/* question 6.2 Finding the lowest rated genre based on IMDb audience score */
...
```{r}
# question 7.1 Finding how genre "Action, Horror, Sci-Fi" scored throughout the years
...
```{r}
#question 7.2. Visualizing how genre "Action, Horror, Sci-fi" scored throughout the years based from imdb
actionhorrorscifi_by_year %>%
  ggplot(aes(x=release_year, y = imdb_scores)) +
...
```{r}
#question 7.3. Visualizing how genre "Action, Horror, Sci-fi" scored throughout the years based from audience scores
actionhorrorscifi_by_year %>%
  ggplot(aes(x=release_year, y = audience_score_rotten_tomatoes)) +
   geom_bar(stat = 'identity', color="white", fill="blue") +
    xlab('release year') +
...
```
```{r}
#question 7.4. Visualizing how genre "Action, Horror, Sci-fi" scored throughout the years based from critic scores
actionhorrorscifi_by_year %>%
  ggplot(aes(x=release_year, y = critic_score_rotten_tomatoes)) +
   geom_bar(stat = 'identity', color="white", fill="blue") +
    xlab('release year') +
...
```
```{sql connection=movie_connection}
/* question 8. Finding how genre "Action" scored throughout the years */
...
```
```{r}
# question 8.1 Finding how genre "Action" scored throughout the years
...
```
```{r}
#question 8.2. Visualizing how genre "Action" scored throughout the years based from IMDb
action_by_year %>%
  ggplot(aes(x=release_year, y = imdb_scores)) +
...
```
```{r}
#question 8.3. Visualizing how genre "Action" scored throughout the years based from audience scores
action_by_year %>%
  ggplot(aes(x=release_year, y = audience_score_rotten_tomatoes)) +
   geom_bar(stat = 'identity', color="white", fill="green") +
    xlab('release year') +
...
```
```{r}
#question 8.4. Visualizing how genre "Action" scored throughout the years based from critic scores
action_by_year %>%
  ggplot(aes(x=release_year, y = critic_score_rotten_tomatoes)) +
   geom_bar(stat = 'identity', color="white", fill="green") +
    xlab('release year') +
...
```{r}
# question 9. Finding the Best/worst films by each genre in the last decade
library(DBI)
...
```{r}
# question 10. Finding how many out of top 10 rated movies by audience scores are directed by women?
...
```{r}
# question 10.1 Finding how many out of top 10 rated movies by audience scores are directed by women?
...
```{r}
# question 11. Finding if there is any difference in action movie rating before 9/11 & after?
...
```{r}
# question 11.1 Finding if there is any difference in action movie rating before 9/11 & after?
...
```{r}
# question 11.2 visualizing the results 
action_movies %>%
...
```{r}
# extra question 12. comparing  5 best movies (from the ones given) according to Nadiia's very biased opinion to their IMDb rating 
...
```{r}
# extra question 12.1 now let's visualize to see if my favorite films are underrated!
fav_films_imdb %>%
...
```{r}
# extra question 12.2 now let's compare my favoutire films and their critic's scores
