...
/* question 2.1 Finding the best movie of each year for the last 10 years */ 
...
```{sql connection=movie_connection}
/* question 2.2. Finding 10 worst films according to rotten tomatoes audience */
select t1.film_name,
...
```{sql connection=movie_connection}
/* question 2.3 Finding 10 worst films according to rotten tomatoes critics */
...
```{sql connection=movie_connection}
/* question 2.4. Finding 10 worst films according to IMDb */
...
```{sql connection=movie_connection} 
/* question 3.1 Finding the highest rated genre based on critic scores */
...
/* the highest rated genre is the combination of Western and Drama and that it is rated significantly lower by the audience */
```
```{sql connection=movie_connection}
/* question 3.2. Finding the highest rated genre based on Rotten Tomatoes audience score */
select t1."genre(s)" as genre,
  t2.score as imdb_scores,
  t3.audience_score as audience_score_rotten_tomatoes, 
  t3.critic_score as critic_score_rotten_tomatoes
...
```{sql connection=movie_connection}
/* question 3.3. Finding the highest rated genre based on IMDb audience scores */
select t1."genre(s)" as genre,
  t2.score as imdb_scores,
  t3.audience_score as audience_score_rotten_tomatoes, 
  t3.critic_score as critic_score_rotten_tomatoes
...
```
```{sql connection=movie_connection}
/* question 4. Finding how genre "Horror, Sci-fi" scored throughout the years */
...
```
```{r}
# question 4.1 Finding how genre "Horror, Sci-fi" scored throughout the years
...
```{r}
# question 4.2. Visualizing how genre "Horror, Sci-fi" scored throughout the years based on IMDb 
horrorscifi_by_year %>%
...
```
```{r}
# question 4.3. Visualizing how genre "Horror, Sci-fi" scored  throughout the years based on audience scores
horrorscifi_by_year %>%
  ggplot(aes(x=release_year, y = audience_score_rotten_tomatoes)) +
   geom_bar(stat = 'identity', color="white", fill="pink") +
    xlab('release year') +
     ylab('audience scores') +
      ggtitle("How Horror, Sci-fi scored") +
       theme(axis.text.x = element_text(angle = 90, size = 8))
```
```{r}
# question 4.4. Vizualizing how genre "Horror, Sci-fi" scored throughout the years based on critic scores
horrorscifi_by_year %>%
  ggplot(aes(x=release_year, y = critic_score_rotten_tomatoes)) +
   geom_bar(stat = 'identity', color="white", fill="pink") +
    xlab('release year') +
     ylab('critic scores') +
      ggtitle("How Horror, Sci-fi scored") +
...
```{sql connection= movie_connection}
/* question 5 Finding the lowest rated genre based on critic scores */
...
```
```{sql connection=movie_connection}
/* question 5.1 Finding the lowest rated genre based on audience score */
...
```{sql connection=movie_connection}
/* question 5.2 Finding the lowest rated genre based on IMDb audience score */
...
```{sql connection=movie_connection}
/* question 6. Finding how genre "Action, Horror, Sci-Fi" scored throughout the years */
...
```{r}
# question 6.1 Finding how genre "Action, Horror, Sci-Fi" scored throughout the years
...
```{r}
#question 6.2. Visualizing how genre "Action, Horror, Sci-fi" scored throughout the years based from imdb
actionhorrorscifi_by_year %>%
  ggplot(aes(x=release_year, y = imdb_scores)) +
   geom_bar(stat = 'identity', color="white", fill="blue") +
    xlab('release year') +
     ylab('imdb scores') +
      ggtitle("How Action, Horror, Sci-fi scored according to IMDB") +
       theme(axis.text.x = element_text(angle = 90, size = 8))
```

```{r}
#question 6.3. Visualizing how genre "Action, Horror, Sci-fi" scored throughout the years based from audience scores
actionhorrorscifi_by_year %>%
  ggplot(aes(x=release_year, y = audience_score_rotten_tomatoes)) +
   geom_bar(stat = 'identity', color="white", fill="blue") +
    xlab('release year') +
     ylab('audience scores') +
      ggtitle("How Action, Horror, Sci-fi scored according to Rotten Tomatoes") +
       theme(axis.text.x = element_text(angle = 90, size = 8))
```
```{r}
#question 6.4. Visualizing how genre "Action, Horror, Sci-fi" scored throughout the years based from critic scores
actionhorrorscifi_by_year %>%
  ggplot(aes(x=release_year, y = critic_score_rotten_tomatoes)) +
   geom_bar(stat = 'identity', color="white", fill="blue") +
    xlab('release year') +
...
```
```{sql connection=movie_connection}
/* question 7. Finding how genre "Action" scored throughout the years */
...
join rotten_tomatoes_scores t3 on t1.film_id=t3.film_id
join imdb_scores t2 on t1.film_id=t2.film_id
where "genre(s)" like '%Action%'
group by release_year
order by t1.release_year asc

```
```{r}
# question 7.1 Finding how genre "Action" scored throughout the years
# plot the distribution of how Action scored throughout the years
# write the sql query in the paste function and store as a variable called query
query <- paste('
select
  t1.release_year,
...
#pass connection to query
action_by_year <- tbl(movie_connection, sql(query))
action_by_year

```
```{r}
#question 7.2. Visualizing how genre "Action" scored throughout the years based from IMDb
action_by_year %>%
  ggplot(aes(x=release_year, y = imdb_scores)) +
   geom_bar(stat = 'identity', color="white", fill="green") +
    xlab('release year') +
     ylab('scores') +
      ggtitle("How Action scored according to IMDb") +
       theme(axis.text.x = element_text(angle = 90, size = 8))
```
```{r}
#question 7.3. Visualizing how genre "Action" scored throughout the years based from audience scores
action_by_year %>%
  ggplot(aes(x=release_year, y = audience_score_rotten_tomatoes)) +
   geom_bar(stat = 'identity', color="white", fill="green") +
    xlab('release year') +
     ylab('audience scores') +
      ggtitle("How Action scored according to Rotten Tomatoes") +
       theme(axis.text.x = element_text(angle = 90, size = 8))
```
```{r}
#question 7.4. Visualizing how genre "Action" scored throughout the years based from critic scores
action_by_year %>%
  ggplot(aes(x=release_year, y = critic_score_rotten_tomatoes)) +
   geom_bar(stat = 'identity', color="white", fill="green") +
    xlab('release year') +
...
```{r}
# question 9.1 Finding how many out of top 10 rated movies by audience scores are directed by women?
...
```{r}
# question 10.1 Finding if there is any difference in action movie rating before 9/11 & after?
...
```{r}
# question 10.2 visualizing the results 
action_movies %>%
